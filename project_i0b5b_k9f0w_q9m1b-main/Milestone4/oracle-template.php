...
$config["dbuser"] = "ora_atykei";			// change "cwl" to your own CWL
$config["dbpassword"] = "a82340886";	// change to 'a' + your student number
...
<body>
	...
	<hr />
	<h2>Insert the new order information</h2>
	<p>Please provide the following details to create your order</p>
